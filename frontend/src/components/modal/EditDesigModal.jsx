...
export default function EditDesigModal({ employee, setEditEmployeeDesignation, updateEmployeeDesignation }) {
...
EditDesigModal.propTypes = {
  employee: PropTypes.function,
  setEditEmployeeDesignation: PropTypes.function,
  updateEmployeeDesignation: PropTypes.function
};