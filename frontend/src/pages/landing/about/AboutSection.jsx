...
export default function About() {
    return (
        ...
        <div className='grid grid-cols-2 lg:px-[4.5rem] lg:pt-48'>
            ...
            <section>   
                <img className='rounded-lg' src={Sanjuan} alt="sanjuan-munisipyo" width={550}/>
            </section>

            {/* container ng title at description */}
            <section className='pt-[65px] pl-6 font-semibold'>
                <div>
                    <h2 className='font-extrabold text-red-700 pb-2 text-[48px]'>ABOUT</h2>
                </div>
                <div>
                    <p className='leading-[180%] text-[20px] font-semibold'>The City Environment and Natural Resources Office (CENRO) supports the Sangguniang Panlungsod and the city mayor in ensuring the delivery of environmental services and facilities, 
