  ...
  return (
     <div className=' text-black min-w-max'>
      ...
      <div  className=""> 
        ...
        <label htmlFor="#" className='gap-3'>Date: Application: </label>
        <input type="date" name="#" id="" className='uppercase border-[2px] w-50 text-black font-bold' />
 
   <div>
            <label htmlFor="" className='pt-2'>Name of Owner: </label>
     ...
     <div  className='pt-2'>
        ...
        <fieldset className=" pt[35%]w-full border border-black mt-6">
            ...
            <div className="mt-4">
              <table className="w-full border-collapse border border-gray-400">
                <thead className="bg-gray-200">
                  <tr>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Species</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Age</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Quantity</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <fieldset className=" pt[35%]w-full border border-black mt-6">
           <legend className="font-semibold">III. ASSESSMENT ( as per City Ordinance No. 73-2018, see back for more details)</legend>
          <div>
        ...
        <fieldset className=" pt[35%]w-full border border-black mt-6">
         ...
         <fieldset className=" pt[35%]w-full border border-black mt-6">
           ...
           <div className="mt-4">
              <table className="w-full border-collapse border border-gray-400">
                <thead className="bg-gray-200">
                  <tr>
                    <th className="border border-gray-400 px-4 py-2 uppercase">qty</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Age</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Species</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">Seed(Packs)</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">seeding(Pieces)</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">garden soil(Packs)</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">seedling(Pieces)</th>
                    <th className="border border-gray-400 px-4 py-2 uppercase">amount</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>total seeds:</label>
              <input type="text" />
            </div>
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>total seedling:</label>
              <input type="text" />
            </div>
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>total garden:</label>
              <input type="text" />
            </div>
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>total amount:</label>
              <input type="text" />
            </div>
         </fieldset>
         <fieldset className=" pt[35%]w-full border border-black mt-6">
         ...
         <div className='mt-4'>
            ...
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>Penalty:</label>
              <input type="text" />
            </div>
            <div className='mt-4'>
              <label htmlFor="" className='uppercase'>certificate to cut trees:</label>
              <input type="text" />
            </div>
            <label htmlFor="" className='uppercase'>grand total (In words):</label>
            <input type="text" />
         </div>
         </fieldset>
